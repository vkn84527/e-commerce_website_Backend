  ...
  try {
    ...
    if (results.length !== 0) {
      ...
      if (results) {
        ...
        return responce.sendtokencustomerResponse(res, 'customer registered sucessfully', token, req.body.customer_email, results.insertId, status_code.STATUS_CODES.SUCCESS)
      }
      else {
